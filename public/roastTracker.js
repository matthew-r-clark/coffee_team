...
function toggleTrackerButtons(tog){
    ...
    input.setAttribute('style','width:125px');
		td1.appendChild(input);
		var td2 = document.createElement('td');
		var btn1 = document.createElement('button');
		btn1.setAttribute('id','temp-button');
    btn1.setAttribute('style','width:135px');
		btn1.appendChild(document.createTextNode('Add Temp (↵)'));
		td2.appendChild(btn1);
		var td3 = document.createElement('td');
		var btn2 = document.createElement('button');
		btn2.setAttribute('id','first-crack');
		btn2.setAttribute('style','width:135px');
		btn2.appendChild(document.createTextNode('1st Crack (f)'));
		td3.appendChild(btn2);
		var td4 = document.createElement('td');
		var btn3 = document.createElement('button');
		btn3.setAttribute('id','second-crack');
		btn3.setAttribute('style','width:135px');
		btn3.appendChild(document.createTextNode('2nd Crack (s)'));
